...
@section('customcss')
    ...
    <style>
        ...
        .preview-area {
            ...
            overflow: inherit;
            /* Hide the overflow to maintain the area size */
        }
                            ...
                            <div class="col-6 mt-5">
                                ...
                                <div class="custom-file-upload">
                                    <label for="formFile" class="upload-area">
                                        ...
                                        <input class="file-input" name="thumbnail" type="file" id="formFile"
                    ...
                    <div class="card border-0 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3 gx-3">
                                <div class="col-5">
                                    <input type="text" id="newSize" class="form-control" name="[size]"
                                        placeholder="e.g Size" />
                                </div>
                                <div class="col-5">
                                    <input type="text" id="newColor" class="form-control" name="[color]"
                                        placeholder="e.g Color" />
                                </div>
                                <div class="col-2">
                                    <button type="button" id="addVariantButton" class="btn btn-primary">Add
                                        Variant</button>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($product->variants as $index => $variant)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    // Find the inventory entry for this variant
                                                    $inventory = $product->inventory->firstWhere(
                                                        'variant_id',
                                                        $variant->id,
                                                    );
                                                @endphp
                        ...
                        <div class="card border-0 mb-4  d-flex align-items-center p-3" style="flex-direction: row; flex-wrap:wrap; gap:2rem">
                            ...
                            <div class="m-5" style="position: relative ">
                                    ...
                                    <span class="bg-danger p-1 rounded" style="position: absolute; top: 10px; right: 10px;"> 
                                        <a href="{{ route('product-images.delete', $image->id) }}" class="text-white">X</a>
                                    </span>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="card border-0 mb-4 d-flex align-items-center  p-3" style="flex-direction: row; flex-wrap:wrap; gap:2rem">
                                ...
                                @foreach ($variant->images as $image)
                                    <div class="m-5" style="position: relative ">
                                        ...
                                        <span class="bg-danger p-1 rounded" style="position: absolute; top: 10px; right: 10px;"> 
                                            <a href="{{ route('variant-images.delete', $image->id) }}" class="text-white">X</a>
                                        </span>
                                    </div>
                                @endforeach
                            </div>
        ...
        document.getElementById('addVariantButton').addEventListener('click', function() {
            ...
            if (size || color) {
                ...
                document.querySelectorAll('.table tbody tr').forEach(row => {
                    const rowSize = row.querySelector(`input[name="variant[${row.rowIndex}][size]"]`)?.value
                        .toLowerCase();
                    const rowColor = row.querySelector(`input[name="variant[${row.rowIndex}][color]"]`)
                        ?.value.toLowerCase();
