                        ...
                        <div class="accordion" id="accCategories">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headCategory">
                                    <button class="accordion-button s-filters-widget-title" type="button" data-bs-toggle="collapse" data-bs-target="#colCategory" aria-expanded="true" aria-controls="colCategory">
                                        Categories
                                    </button>
                                </h2>
                        ...
                        <div class="accordion" id="accBrands">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headBrands">
                                    <button class="accordion-button s-filters-widget-title" type="button" data-bs-toggle="collapse" data-bs-target="#colBrands" aria-expanded="false" aria-controls="colBrands">
                                        Brands
                                    </button>
                                </h2>
                                        ...
                                        <div class="s-filters-widget-values">
                                            <form class="filter-form" id="price-filter-form" method="GET" action="{{ route('products.search') }}">
                                                ...
                                                <label class="s-filters-label" for="price-1">
                                                    <input id="price-1" name="filter[price]" type="radio" class="s-filters-radio" value="100-200" {{ request('filter.price') == '100-200' ? 'checked' : '' }}> 100 SAR to 200 SAR
                                                </label>
                                                <label class="s-filters-label" for="price-2">
                                                    <input id="price-2" name="filter[price]" type="radio" class="s-filters-radio" value="200-300" {{ request('filter.price') == '200-300' ? 'checked' : '' }}> 200 SAR to 300 SAR
                                                </label>
                                                <label class="s-filters-label" for="price-3">
                                                    <input id="price-3" name="filter[price]" type="radio" class="s-filters-radio" value=">300" {{ request('filter.price') == '>300' ? 'checked' : '' }}> more than 300 SAR
                                                </label>
