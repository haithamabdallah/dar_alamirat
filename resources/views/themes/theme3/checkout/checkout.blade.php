...
<body class="checkout_page">
    ...
    <div id="checkout">
        ...
        <div class="container">
            ...
            @include('themes.theme3.checkout.partials.header')

            @include('themes.theme3.checkout.partials.order-summary')
            ...
            <div class="accordion" id="checkoutAccordion">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            ...
                            @include('themes.theme3.checkout.partials.new-address')

                            @include('themes.theme3.checkout.partials.edit-address')
                ...
                @include('themes.theme3.checkout.partials.shipping')
                ...
                <div class="accordion-item">
                    ...
                    @include('themes.theme3.checkout.partials.payment')
                </div>
            </div>
            <!-- ./Payment -->
    ...
    @include('themes.theme3.checkout.scripts.script ')
